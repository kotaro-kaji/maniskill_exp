...
import tasks.dual.task_dual_trash_bin_rolling  # registers MyDualTrashBinRolling-v0
...
if __name__ == "__main__":
    ...
    if args.capture_video or args.save_trajectory:
        eval_video_envs = gym.make(args.env_id, num_envs=args.num_eval_video_envs, reconfiguration_freq=args.eval_reconfiguration_freq, human_render_camera_configs=dict(shader_pack="default"), **env_kwargs)
    ...
    while global_step < args.total_timesteps:
        if args.eval_freq > 0 and (global_step - args.training_freq) // args.eval_freq < global_step // args.eval_freq:
            ...
            if eval_video_envs is not None:
                ...
                for eval_step in range(args.num_eval_steps):
                    with torch.no_grad():
                        eval_video_action = actor.get_eval_action(eval_video_obs)
                        eval_video_obs, _, _, _, _ = eval_video_envs.step(eval_video_action)
            eval_metrics_mean = {}

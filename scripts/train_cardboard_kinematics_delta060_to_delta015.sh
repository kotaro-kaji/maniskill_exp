...
#
# Usage:
#   bash scripts/train_cardboard_kinematics_delta060_to_delta015.sh <randomized_v2_delta060_best_ckpt>
#   PYTHON_BIN=.venv/bin/python bash scripts/train_cardboard_kinematics_delta060_to_delta015.sh <ckpt>

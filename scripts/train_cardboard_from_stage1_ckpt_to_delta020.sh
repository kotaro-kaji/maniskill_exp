...
# Continue the non-kinematics cardboard curriculum from a prepared stage1
# delta=0.06 checkpoint:
#   stage2 randomized-v1 -> stage3 randomized-v2 -> delta=0.03 -> delta=0.02
#
# Usage:
#   bash scripts/train_cardboard_from_stage1_ckpt_to_delta020.sh <stage1_delta060_ckpt>
#
# Useful overrides:
#   SEED=1 \
...
#   PYTHON_BIN=python \
#   bash scripts/train_cardboard_from_stage1_ckpt_to_delta020.sh runs/.../ckpt_231.pt
...
echo
echo "### stage2 randomized-v1 and stage3 randomized-v2 from stage1 checkpoint"
...
echo
echo "### resumed curriculum input checkpoint summary"

...
from tasks.dual.task_dual_simple import MyDualSimpleEnv  # noqa: F401  # registers the task
from tasks.dual.task_dual_box_rotation import MyDualBoxRotationEnv  # noqa: F401  # registers the task

...
def main():
    ...
    final_arm_mean_abs_error = final_arm_abs_error.mean(dim=-1)
    final_arm_max_abs_error = final_arm_abs_error.max(dim=-1).values
    final_arm_score = (1.0 - torch.tanh(final_arm_abs_error)).mean(dim=-1)

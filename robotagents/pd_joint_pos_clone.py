...
class LocalPDJointPosController(BaseController):
    config: "LocalPDJointPosControllerConfig"
    _start_qpos = None
    _target_qpos = None
...
@dataclass
class LocalPDJointPosControllerConfig(ControllerConfig):
    ...
    controller_cls = LocalPDJointPosController

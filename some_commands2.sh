...
python src/bin/teleop_spacemouse_dual_xarm7.py --env-id MyDualCardboardCabinet-v1
python src/bin/teleop_keyboard_dual_xarm7.py --env-id MyDualCardboardCabinet-v1
...
python ppo_rollout_single_xarm7.py \
...
python eval_scripts/record_cardboard_policy_video.py \
...
python eval_scripts/eval_cardboard_randomized_policy_metrics.py \
    --checkpoint <randomized_v2_ckpt> \
...
python ppo_dual_xarm7_low_freq.py \
